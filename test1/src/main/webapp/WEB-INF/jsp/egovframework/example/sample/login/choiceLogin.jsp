...
<body>
	<div class ="loginbtn" style="margin:100px 500px 100px 500px;">
		<div class="common_loginbtn" style="display:flex; justify-content:center; margin-top:30px; ">
			<a href="LoginForm.do" style="display:flex; justify-content:center; align-items:center;text-align: center;width:400px; height:5vh;border:2px solid; border-color:black; border-radius:1.2rem;font-weight:bold; font-size:x-large;text-decoration:none;">일반 로그인</a>
		</div>
